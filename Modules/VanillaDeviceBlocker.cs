...
//    private static readonly Dictionary<int, Vector2[]> DevicePositions =
...
//        bool optionEnabled =
//            Options.DisableDevice != null &&
//            Options.DisableDevice.GetBool();

//        return isJbMode || optionEnabled;
//    }
...
//        SetLocalDeviceCollidersBlocked(_lastEnabledState);
//    }
...
//        if (!_localStateInitialized || enabled != _lastEnabledState)
//        {
//            SetLocalDeviceCollidersBlocked(enabled);
...
//        foreach (Vector2 devicePosition in positions)
//        {
//            if (Vector2.Distance(
//                    playerPosition,
//                    devicePosition) <= usableDistance)
//            {
//                return true;
//            }
//        }
...
//    private static void SetLocalDeviceCollidersBlocked(
//        bool blocked)
//    {
//        if (!AmongUsClient.Instance.AmHost)
//            return;
...
//    private static bool IsBlockedSystemConsole(
//        int mapId,
//        string consoleName)
//    {
//        switch (mapId)
...
//            case 0:
//                // The Skeld Cameras
//                return consoleName == "SurvConsole";

//            case 2:
//                // Polus Cameras and Vitals
//                return consoleName == "Surv_Panel" ||
//                       consoleName == "panel_vitals";

//            case 4:
//                // Airship Cameras and Vitals
//                return consoleName == "task_cams" ||
//                       consoleName == "panel_vitals";

//            case 5:
//                // The Fungle Vitals
//                return consoleName == "VitalsConsole";
